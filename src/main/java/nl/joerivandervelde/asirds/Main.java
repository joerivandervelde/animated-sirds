...
public class Main {
    public static void main(String[] args) throws Exception
    {
        ...
        new AnimatedSIRDS(new File("gifs/a-sphere-r0.4-d0.1.gif"), new File("gifs/a-sphere-r0.4-d0.1-noisy.gif"), true, false).convert();

        // try out 'calm' sirds image from reference depth map
        new AnimatedSIRDS(new File("gifs/a-sphere-r0.4-d0.1.gif"), new File("gifs/b-sphere-r0.4-d0.1-calm.gif"), false, false).convert();
        ...
        new AnimatedSIRDS(new File("gifs/c-sphere-r0.4-d1.0.gif"), new File("gifs/c-sphere-r0.4-d1.0-noisy.gif"), true, false).convert();
        ...
        new AnimatedSIRDS(new File("gifs/d-sphere-r1.0-d0.1.gif"), new File("gifs/d-sphere-r1.0-d0.1-noisy.gif"), true, false).convert();

        // use reference depth map, but now color sirds instead of monochrome
        new AnimatedSIRDS(new File("gifs/a-sphere-r0.4-d0.1.gif"), new File("gifs/e-sphere-color-noisy.gif"), true, true).convert();
